    ...
    <div id="page-wrap">
        ...
        <?php
            ...
            if (isset($_POST['submit'])) {
                ...
                $query = "INSERT INTO soferi  (nume_prenume, functie, telefon, email, id_societate)
                     VALUES ('$nume_prenume', '$functie', '$telefon', '$email', '$id_societate');";
                ...
                //dacă s-a transmis un id de societate, îl preluăm, altfel facem un select cu soferi
                $societate = false;
                if (isset($_GET['id'])) {
    		...
    		<article>
    			<header>
    				<h1>Adăugare șofer <?php if ($societate) {
                        echo " - societate " . $id .": ". $row['denumire'];
                    } ?></h2>
    			</header>
                         <form id="sofer" action="nousofer.php<?php if ($societate) {
                        echo "?id=$id";
                    } ?>" method="post">
                                ...
                                <?php
                                    ...
                                    <input type="text" name="nume_prenume" id="nume_prenume" value="" >
                                </div>
																<div>
