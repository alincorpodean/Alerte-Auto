                ...
                <?php
                    if (isset($_GET['id'])) {
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $query = "SELECT * FROM alerte WHERE id=".$id;
                            ...
                            <form id="editalerta" action="modalerta.php?id=<?=$id?>" method="post">
                                    ...
                                    <select name="societate" id="societate" >
                                        <?php
                                            while ($societate = mysqli_fetch_assoc($result_societati)) {
                                                if ($societate['id']==$alerta['id_societate']) {
                                                    //facem sa fie preselectat acea societate care este curent pe alerta
                                ...
                                <div>
                                    ...
                                    <input type="date" name="data_inceput" id="data_inceput" value="<?=$alerta["data_inceput"]?>" >
                                </div>
                                <div>
                        ...
                        echo "<p>Mergeți înapoi la <a href='alerte.php'>alerte</a> și selectați una.</p>";
                    }
