...
<body>
    ...
    <?php
        ...
        $query = "
            SELECT v.id, v.nr_inmatriculare, v.marca, v.model, s.denumire
            FROM  societati s, vehicule v
            WHERE v.id_societate=s.id
    	...
    	<section id="main">
    		...
    		<article>
                        ...
                        <?php
                            if (mysqli_num_rows($rezultat) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($rezultat)) {
                                    ...
                                    echo "<td>" . $row["marca"] . "</a></td>";
                                    echo "<td>" . $row["model"] . "</a></td>";
                                    echo "<td>" . $row["denumire"] . "</td>";

                                    echo "<td><a href='modvehicul.php?id=" . $row["id"] . " '><img src='img/edit.png' alt='edit icon' width='32px'></a></td>";
                                    echo "<td><a href='vehicule.php?id=" . $row["id"] . "&action=delete'><img src='img/delete.png' alt='delete icon' width='32px'></a></td>";
                                    echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='8'>Nu aveti vehicule</td></tr>";
                            } ?>
                    </table>
                    <button type="button"><a href="nouvehicul.php">Adăugare vehicul</a></button>
                ...
                <?php
                                    ...
                                    if ($action == "delete") {
                                        //șterge vehicul
                                        $query = "DELETE from vehicule where id=".$_GET['id'];
                                        ...
                                        if (!$result) {
                                            ...
                                            echo "<meta http-equiv=\"refresh\" content=\"2; URL='vehicule.php'\" >";
                                        }
                                    }
                                }
