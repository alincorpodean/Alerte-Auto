...
$sql = "select r.data as Data, r.service as Service, r.reparatie as Reparatie, ROUND(r.valoare,2) as Valoare, r.km as KM, v.nr_inmatriculare as Vehicul
from reparatii r, vehicule v
WHERE r.id_vehicul=v.id
